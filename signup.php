...
<!--- Container --->                 
 ...
 ?>
                ...
                <h3 style="color: #ff3333;">Customer Sign Up </h3>
...
<label>Birthday  :</label><input type="date" name="birthday" class="box"/><br/>
<label>City  :</label><input type="text" name="city" class="box"/><br/>
<label>Country  :</label><input type="text" name="country" class="box"/><br/>
